...
<div class="billto-shipto">
	<div class="width50 floatleft">
		...
		<span style="margin: 0 0 20px;"><span class="vmicon vm2-billto-icon"></span>
	...
	<div class="width50 floatleft">
		...
		<span style="margin: 0 0 20px;"><span class="vmicon vm2-shipto-icon"></span>
			<?php echo vmText::_ ('COM_VIRTUEMART_USER_FORM_SHIPTO_LBL'); ?></span></br>
