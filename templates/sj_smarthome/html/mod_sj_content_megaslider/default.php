...
<div class="megaslider" id="megaslider_<?php echo $instance;?>" ><!--Begin sj-content-slideshow-->		
	...
	<div class="mgsl-wrap <?php echo $options->theme ?>" ><!--Begin sj-mgsl-wrap-->
		<div class="mgsl-wrap-inner <?php echo  ($options->direction_display_when=='hover')?'hover':'always'; ?>"  >
						...
						<div class="mgsl-item-content" >	
							...
							<div class="item-date">
								<span class="entry-date">
									<i class="fa fa-calendar-o"></i><?php echo JHtml::_('date', $item->created, 'd m Y'); ?>
								</span>
								<span class="entry-user">
									<i class="fa fa-user-o"></i><?php echo $item->author; ?>												
								</span>
							</div>
			...
			<div class="mgsl-control" style="z-index:<?php echo 2*count($list); ?>; height:<?php echo $options->imgcfgnav_height + 78?>px;" >												
				...
				<div class="mgsl-control-inner">			
					...
					<?php } ?>
					<?php $left_right=$options->prevnext_display==1?25:0; ?>		
