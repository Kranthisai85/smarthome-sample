...
<div class="orderby-displaynumber top row">
	...
	<div class="toolbar-center col-md-10 col-sm-9 hidden-xs">
		...
		<div class="title"><?php echo JText::_('SHOW_AS');	?></div><?php echo $this->vmPagination->getLimitBox ($this->category->limit_list_step); ?>
		</div>	
	</div>
...
<?php } ?>
	...
	<div class="orderby-displaynumber bottom row">
		...
		<?php echo $this->vmPagination->getPagesLinks (); ?><span class="vm-page-counter"><?php echo $this->vmPagination->getPagesCounter (); ?></span>
		</div>
		<?php } ?>
	</div>
